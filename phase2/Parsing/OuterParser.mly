...
packageDeclaration: 
  | PACKAGE n = separated_nonempty_list(DOT, IDENTIFIER) SEMI { n }

importDeclaration:
  | IMPORT STATIC? importName SEMI {}
...
classOrInterfaceType:
  | l=separated_nonempty_list(DOT,IDENTIFIER)  { Type.extract_type l }
